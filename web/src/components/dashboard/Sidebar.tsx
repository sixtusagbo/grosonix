...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        'flex flex-col h-full bg-charcoal-900/95 backdrop-blur-xl border-r border-emerald-500/20 transition-all duration-300',
            ...
            <Link
              ...
              className={cn(
                ...
                active
                  ...
                  : 'text-silver hover:text-white hover:bg-slate-surface-700/50',
                      ...
                      {item.badge && (
                        <span
                          className={cn(
                            ...
                            item.badge === 'AI' && 'bg-emerald-500/20 text-emerald-400',
                            item.badge === 'New' && 'bg-electric-orange-500/20 text-electric-orange-400',
                            item.badge === 'Soon' && 'bg-neon-cyan-500/20 text-neon-cyan-400',
                            item.badge === 'Pro' && 'bg-electric-orange-500/20 text-electric-orange-400'
                          )}
                        >
                          {item.badge}
                        </span>
      ...
      {!isCollapsed && (
        <div className="p-4">
          <div className="neo-brutal-card p-4 bg-gradient-to-br from-electric-orange-500/10 to-emerald-500/10">
            ...
            <Button
              size="sm"
              className="w-full neo-brutal-button text-xs"
            >
              Upgrade Now
            </Button>
          </div>
