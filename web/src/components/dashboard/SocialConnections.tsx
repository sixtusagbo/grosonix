  ...
  const platforms = [
    {
      ...
      description:
        "Connect your Twitter account to track followers and engagement",
    },
    {
      id: "instagram",
      name: "Instagram",
    ...
    <div className="glass-card p-6">
      ...
      <div className="space-y-4">
        {platforms.map((platform) => {
          ...
          return (
            <div
              key={platform.id}
              className="bg-midnight rounded-lg p-4 border border-electric-purple/20">
      ...
      <div className="mt-6 p-4 bg-midnight/50 rounded-lg border border-warning-orange/20">
        <p className="text-sm text-warning-orange">
          <strong>Coming Soon:</strong> Social media integrations are currently
          in development. You'll be able to connect your accounts and start
          tracking your growth metrics soon!
        </p>
      </div>
    </div>
  );
