  ...
  return (
    <Card className={className}>
      ...
      <CardContent className="space-y-4 p-3 sm:p-4">
          ...
          <TabsContent value={activeTab} className="space-y-4 mt-4">
            ...
            {activeChallenges.length > 0 ? (
              ...
              <div className="text-center py-6 sm:py-8">
                <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-yellow-500 mx-auto mb-3 sm:mb-4"></div>
              ...
              <div className="text-center py-6 sm:py-8">
                ...
                <p className="text-sm font-medium mb-2">No active challenges</p>
                <p className="text-xs sm:text-sm text-muted-foreground mb-4">
                  Generate a new challenge to start earning XP!
                </p>
              </div>
            )}
        ...
        {/* XP Explanation */}
        <div className="text-xs text-muted-foreground bg-yellow-500/10 p-2 sm:p-3 rounded-md">
          <div className="flex items-center gap-1 font-medium mb-1">
            <Zap className="w-3 h-3 text-yellow-500" />
            <span>Challenge Rewards</span>
          </div>
          <p>Complete challenges to earn XP and make progress on your goals.</p>
        </div>
      </CardContent>
    </Card>
  );
