    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="container mx-auto py-6 px-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold bg-hero-gradient bg-clip-text text-transparent">Grosonix</span>
        </div>
        <div className="flex items-center space-x-4">
          <Link href="/auth/login" className="text-text-primary hover:text-emerald-500 transition-colors">
            Login
          </Link>
      ...
      <section className="container mx-auto px-4 py-20 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 mb-10 lg:mb-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link href="/auth/login">
              <Button size="lg" variant="outline" className="border-emerald-500/50 text-emerald-500 hover:bg-emerald-500/10">
                Login
              </Button>
            </Link>
          </div>
        ...
        <div className="lg:w-1/2 relative">
          <div className="relative z-10 glass-card border-emerald-500/20 p-6 rounded-xl shadow-xl transform rotate-2 hover:rotate-0 transition-all duration-300">
          ...
          <div className="absolute top-20 -right-4 z-0 glass-card border-neon-cyan-500/20 p-6 rounded-xl shadow-xl transform -rotate-3 hover:rotate-0 transition-all duration-300">
            <div className="flex items-center gap-3 mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card border-electric-orange-500/20 p-6 rounded-xl hover:shadow-glow-orange transition-all duration-300">
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-electric-orange-500 mr-2" />
            ...
            <div className="glass-card border-neon-cyan-500/20 p-6 rounded-xl hover:shadow-glow-cyan transition-all duration-300">
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="w-4 h-4 text-neon-cyan-500 mr-2" />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="glass-card border-electric-orange-500/20 p-6 rounded-xl shadow-lg relative transform scale-105 hover:shadow-glow-orange transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-electric-orange-500 mr-3" />
            ...
            <div className="glass-card border-neon-cyan-500/20 p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-neon-cyan-500 mr-3" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-card border-electric-orange-500/20 p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-electric-orange-500/20 rounded-full flex items-center justify-center mr-4">
            ...
            <div className="glass-card border-neon-cyan-500/20 p-6 rounded-xl hover:shadow-lg transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-neon-cyan-500/20 rounded-full flex items-center justify-center mr-4">
